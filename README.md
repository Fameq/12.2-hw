# Домашнее задание к занятию 12.2 "Работа с данными (DDL/DML)" - Кувайсков Дмитрий
...
![alt text](https://github.com/Fameq/12.2-hw/blob/master/img/user.png)

1.4 Дайте все права для пользователя sys_temp. 

1.5 Выполните запрос на получение списка прав для пользователя sys_temp. (скриншот)

![alt text](https://github.com/Fameq/12.2-hw/blob/master/img/grants.png)
...
![alt text](https://github.com/Fameq/12.2-hw/blob/master/img/diagram.png)
...
![alt text](https://github.com/Fameq/12.2-hw/blob/master/img/primary.png)
